...
export const loginTranslations = {
 ...
 brandMark:'健康庫 LogVita', h1:'把每一次<em>就診紀錄</em><br>好好留下來',
 brandDesc:'檢驗報告、用藥紀錄、影像資料，統一安全存放。就醫時隨手調閱，換醫院、換科別都不用再重新說明一次病史。',
 trust:'資料採加密儲存，僅本人與您授權的醫療人員可讀取',
 ...
 password:'密碼', passwordPh:'至少 6 個字元', create:'建立帳號', noAccount:'還沒有帳號？', hasAccount:'已經有帳號了？',
 ...
 errName:'請輸入姓名。', errEmail:'請輸入有效的電子郵件地址。', errPassword:'密碼至少需要 6 個字元。',
 ...
 brandMark:'健康库 LogVita', h1:'把每一次<em>就诊记录</em><br>好好留存',
 brandDesc:'检验报告、用药记录、影像资料，统一安全存放。就医时随手调阅，换医院、换科别都不用再重新说明病史。',
 trust:'数据采用加密存储，仅本人与您授权的医疗人员可读取',
 ...
 password:'密码', passwordPh:'至少 6 个字符', create:'创建账号', noAccount:'还没有账号？', hasAccount:'已经有账号了？',
 createAccount:'创建账号', terms:'注册即表示您同意我们的<a id="open-tos-btn">服务条款</a>与<a id="open-privacy-btn">隐私政策</a>，', privacy:'您的健康数据受个人信息保护法律法规保护。',
 errName:'请输入姓名。', errEmail:'请输入有效的电子邮件地址。', errPassword:'密码至少需要 6 个字符。',
 ...
 brandMark:'LogVita', h1:'Keep every <em>medical record</em><br>safe and accessible',
 brandDesc:'Store test reports, medication records, and medical images securely in one place. Access them whenever you need them.',
 trust:'Encrypted storage. Accessible only by you and authorized healthcare professionals.',
 ...
 password:'Password', passwordPh:'At least 6 characters', create:'Create account', noAccount:"Don't have an account?", hasAccount:'Already have an account?',
 ...
 errName:'Please enter your name.', errEmail:'Please enter a valid email address.', errPassword:'Password must be at least 6 characters.',
 ...
 brandMark:'LogVita', h1:'すべての<em>診療記録</em>を<br>安全に保管',
 brandDesc:'検査結果、処方箋、画像データを一箇所で安全に管理。転院時も病歴の説明がスムーズに。',
 trust:'暗号化保管。あなたと許可された医療従事者のみが閲覧可能。',
 ...
 password:'パスワード', passwordPh:'6文字以上', create:'アカウント作成', noAccount:'アカウントをお持ちでないですか？', hasAccount:'すでにアカウントをお持ちですか？',
 ...
 errName:'お名前を入力してください。', errEmail:'有効なメールアドレスを入力してください。', errPassword:'パスワードは6文字以上である必要があります。',
 ...
 brandMark:'LogVita', h1:'모든 <em>진료 기록</em>을<br>안전하게 보관하세요',
 brandDesc:'검사 결과, 처방 기록, 영상 자료를 한곳에 안전하게 저장하고 언제든지 쉽게 확인하세요.',
 trust:'암호화 저장. 본인 및 승인된 의료진만 접근 가능합니다.',
 ...
 password:'비밀번호', passwordPh:'최소 6자 이상', create:'계정 생성', noAccount:'계정이 없으신가요?', hasAccount:'이미 계정이 있으신가요?',
 ...
 errName:'이름을 입력해 주세요.', errEmail:'올바른 이메일 주소를 입력해 주세요.', errPassword:'비밀번호는 최소 6자 이상이어야 합니다.',
...
'zh-TW': {
  ...
  recordModal: { newTitle:'新增醫療紀錄', newSub:'紀錄會安全儲存於你的個人 Google Drive 或 Dropbox', typeLabel:'紀錄類型',
    ...
    uploadFailedToast:'照片上傳失敗，紀錄仍會保留文字內容', invalidImageToast:'請上傳圖片格式的檔案', tooLargeToast:'照片檔案請小於 8MB',
  ...
  avatar: { uploading:'上傳中...', updatedCloudToast:'大頭貼已更新並同步至雲端', updatedLocalToast:'大頭貼已更新（尚未連結雲端硬碟，暫存於本次瀏覽）',
    removedCloudToast:'已移除自訂大頭貼，改回預設頭像', removedLocalToast:'已移除自訂大頭貼', needCloudToast:'請先連結 Google Drive 或 Dropbox 以上傳照片',
    removeConfirmTitle:'確定要移除目前的大頭貼照片嗎？', removeConfirmMsg:'移除後將改回預設頭像。',
    invalidImageToast:'請上傳圖片格式的檔案', tooLargeToast:'照片檔案請小於 8MB' },
...
'zh-CN': {
  ...
  recordModal: { newTitle:'新增医疗记录', newSub:'记录会安全储存于你的个人 Google Drive 或 Dropbox', typeLabel:'记录类型',
    ...
    uploadFailedToast:'照片上传失败，记录仍会保留文字内容', invalidImageToast:'请上传图片格式的文件', tooLargeToast:'照片文件请小于 8MB',
  ...
  avatar: { uploading:'上传中...', updatedCloudToast:'头像已更新并同步至云端', updatedLocalToast:'头像已更新（尚未连结云端硬盘，暂存于本次浏览）',
    removedCloudToast:'已移除自定义头像，改回默认头像', removedLocalToast:'已移除自定义头像', needCloudToast:'请先连结 Google Drive 或 Dropbox 以上传照片',
    removeConfirmTitle:'确定要移除目前的头像照片吗？', removeConfirmMsg:'移除后将改回默认头像。',
    invalidImageToast:'请上传图片格式的文件', tooLargeToast:'照片文件请小于 8MB' },
...
'en': {
  ...
  recordModal: { newTitle:'Add medical record', newSub:'Records are stored securely in your personal Google Drive or Dropbox', typeLabel:'Record type',
    ...
    uploadFailedToast:'Photo upload failed — the record\u2019s text content was still saved', invalidImageToast:'Please upload an image file', tooLargeToast:'Photo must be under 8MB',
  ...
  avatar: { uploading:'Uploading...', updatedCloudToast:'Avatar updated and synced to the cloud', updatedLocalToast:'Avatar updated (not yet linked to cloud storage — kept for this session only)',
    removedCloudToast:'Custom avatar removed — back to default', removedLocalToast:'Custom avatar removed', needCloudToast:'Connect Google Drive or Dropbox first to upload a photo',
    removeConfirmTitle:'Remove your current avatar?', removeConfirmMsg:'It will revert to the default avatar.',
    invalidImageToast:'Please upload an image file', tooLargeToast:'Photo must be under 8MB' },
...
'ja': {
  ...
  recordModal: { newTitle:'医療記録を追加', newSub:'記録はお客様個人の Google Drive または Dropbox に安全に保存されます', typeLabel:'記録の種類',
    ...
    uploadFailedToast:'写真のアップロードに失敗しました。テキスト内容は保存されます', invalidImageToast:'画像形式のファイルをアップロードしてください', tooLargeToast:'写真は8MB以下にしてください',
  ...
  avatar: { uploading:'アップロード中...', updatedCloudToast:'アバターを更新し、クラウドに同期しました', updatedLocalToast:'アバターを更新しました（クラウド未連携のため今回の閲覧のみ有効）',
    removedCloudToast:'カスタムアバターを削除し、デフォルトに戻しました', removedLocalToast:'カスタムアバターを削除しました', needCloudToast:'写真をアップロードするには先に Google Drive または Dropbox と連携してください',
    removeConfirmTitle:'現在のアバター写真を削除しますか？', removeConfirmMsg:'削除するとデフォルトのアバターに戻ります。',
    invalidImageToast:'画像形式のファイルをアップロードしてください', tooLargeToast:'写真は8MB以下にしてください' },
...
'ko': {
  ...
  recordModal: { newTitle:'의료 기록 추가', newSub:'기록은 회원님 개인의 Google Drive 또는 Dropbox에 안전하게 저장됩니다', typeLabel:'기록 유형',
    ...
    uploadFailedToast:'사진 업로드에 실패했습니다. 텍스트 내용은 저장됩니다', invalidImageToast:'이미지 형식의 파일을 업로드해 주세요', tooLargeToast:'사진 파일은 8MB 이하여야 합니다',
  ...
  avatar: { uploading:'업로드 중...', updatedCloudToast:'아바타가 업데이트되고 클라우드에 동기화되었습니다', updatedLocalToast:'아바타가 업데이트되었습니다 (클라우드 미연동으로 이번 세션에만 유지됩니다)',
    removedCloudToast:'사용자 지정 아바타가 제거되고 기본값으로 돌아갔습니다', removedLocalToast:'사용자 지정 아바타가 제거되었습니다', needCloudToast:'사진을 업로드하려면 먼저 Google Drive 또는 Dropbox를 연결하세요',
    removeConfirmTitle:'현재 아바타 사진을 제거하시겠습니까?', removeConfirmMsg:'제거하면 기본 아바타로 돌아갑니다.',
    invalidImageToast:'이미지 형식의 파일을 업로드해 주세요', tooLargeToast:'사진 파일은 8MB 이하여야 합니다' },
